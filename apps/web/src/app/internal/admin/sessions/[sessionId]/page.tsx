...
import {
  ...
  getInternalSessionReviewRecordById,
  sessionStatusLabels,
  sessionTypeLabels,
...
export default async function SuspiciousSessionDetailPage({
  ...
  const session = getInternalSessionReviewRecordById(
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <header className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">
            Suspicious-session detail
          </p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight">
            {session.participantIdentifier}
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
            This page converts suspicious-session visibility into actionable
            review. The indicators should guide internal interpretation, not
            produce automatic allegations or irreversible decisions.
          </p>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <dl className="mt-5 space-y-3 text-sm">
                <div className="flex justify-between gap-4 rounded-xl bg-slate-50 px-4 py-3">
                  ...
                  <dd className="font-semibold">{session.sessionId}</dd>
                </div>
                <div className="flex justify-between gap-4 rounded-xl bg-slate-50 px-4 py-3">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <dl className="mt-5 space-y-3 text-sm">
                <div className="rounded-xl bg-slate-50 px-4 py-3">
                  ...
                  <dd className="mt-1 font-semibold">{session.startedAt}</dd>
                </div>
                <div className="rounded-xl bg-slate-50 px-4 py-3">
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    These rule-based triggers explain why the session entered
                    the suspicious review queue.
                  </p>
                </div>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="text-lg font-semibold">
                Access and submission pattern
              </h2>

              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div className="rounded-xl bg-slate-50 p-4">
                  <h3 className="text-sm font-semibold">Access anomaly</h3>
                ...
                <div className="rounded-xl bg-slate-50 p-4">
                  <h3 className="text-sm font-semibold">Submission pattern</h3>
                  <p className="mt-2 text-sm leading-6 text-slate-700">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                This field is currently a frontend scaffold. Later it should
                persist reviewer comments through the internal API and audit
                log.
              </p>
